...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { employee_id: @time_entry.employee_id, name: @time_entry.name, project_id: @time_entry.project_id }
    end
  ...
  test "should update time_entry" do
    patch :update, id: @time_entry, time_entry: { employee_id: @time_entry.employee_id, name: @time_entry.name, project_id: @time_entry.project_id }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
